            ...
            <table class="table table-dark">
                ...
                <?php 
                    ...
                    <tr class="trow">
                        ...
                        <td><a href="updatedata.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="deletedata.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
