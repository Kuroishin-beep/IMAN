            ...
            <table class="table table-dark">
                ...
                <?php 
                    ...
                    <tr class="trow">
                        ...
                        <td><a href="updatedata.php?customer_id=<?php echo $row['customer_id']; ?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="deletedata.php?customer_id=<?php echo $row['customer_id']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
