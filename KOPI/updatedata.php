...
if(isset($_GET['id'])){
    ...
    $sql_query = "SELECT * FROM customer WHERE ref_id='$id'";
...
if(isset($_POST['submit'])){
    ...
    $totalprice = $_POST['totalprice']; // Retrieve totalprice from the form

    // Update data in the database
    $sql_query = "UPDATE results SET firstname='$firstname', lastname='$lastname', phonenum='$phonenum', totalprice='$totalprice' WHERE ref_id='$id'";
...
<div class="container">
    ...
    <form name="calculator" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="container">
            <h2 style="text-align: center;margin: 50px 0;">Customer Data</h2>
